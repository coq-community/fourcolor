...
(*                more accurately described as a of point denotations. We do  *)
(*                not define the value equality on points, however, as it is  *)
(*                not needed for stating nor proving the Four Color Theorem.  *)
